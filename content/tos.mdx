...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Chop AI.
...
- **Application** refers to Chop AI, the software program provided by the Company.
...
- By email: me@alvropena.com
- By visiting this page on our website: [https://chop.so/support](https://chop.so/support)
